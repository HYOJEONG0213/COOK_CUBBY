...
###  커비에게 좋은 음식만 먹입시다!
<img src = "cry_cubby.png" width="200px" height="200px"></img><br/>
...
---
## 어려웠던 점
### * pygame 라이브러리를 사용할 때 캐릭터의 크기를 늘리고 줄이는 부분이 어려웠었습니다. 음식을 먹을때마다 크기를 키우고, 민초를 먹거나 피버타임이 끝나면 크기를 원상태로 돌려야하는데 안돌아가는 오류도 있었습니다.
